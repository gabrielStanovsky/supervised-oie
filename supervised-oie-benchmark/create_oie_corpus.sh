...
echo "train..."
python ./qa_to_oie.py --in ./QASRL-full/newswire/propbank.train.qa --out ./oie_corpus/newswire/propbank.train.oie --conll=./oie_corpus/newswire/propbank.train.oie.conll --oieinput=./raw_sentences/newswire/propbank.train.txt
echo "test..."
python ./qa_to_oie.py --in ./QASRL-full/newswire/propbank.test.qa --out ./oie_corpus/newswire/propbank.test.oie --conll=./oie_corpus/newswire/propbank.test.oie.conll --oieinput=./raw_sentences/newswire/propbank.test.txt
echo "Extracting from wiki..."
echo "dev..."
python ./qa_to_oie.py --in ./QASRL-full/wiki/wiki1.dev.qa --out ./oie_corpus/wiki/wiki1.dev.oie --conll=./oie_corpus/wiki/wiki1.dev.oie.conll --oieinput=./raw_sentences/wiki/wiki1.dev.txt
echo "train..."
python ./qa_to_oie.py --in ./QASRL-full/wiki/wiki1.train.qa --out ./oie_corpus/wiki/wiki1.train.oie --conll=./oie_corpus/wiki/wiki1.train.oie.conll --oieinput=./raw_sentences/wiki/wiki1.train.txt
echo "test..."
python ./qa_to_oie.py --in ./QASRL-full/wiki/wiki1.test.qa --out ./oie_corpus/wiki/wiki1.test.oie --conll=./oie_corpus/wiki/wiki1.test.oie.conll --oieinput=./raw_sentences/wiki/wiki1.test.txt

...
Within this framework, we will use a bi-LSTM transducer, inspired by the state of the art deep learning approach for SRL suggested by \newcite{baidusrl} (elaborated in Section \ref{sec:related}).
...
In particular, we use 3 layers of stacked bi-LSTMs, where each LSTM cell is composed of 128 hidden units
...
to predict the part of speech for feature computation.% and predicate head identification (identifying verbs).

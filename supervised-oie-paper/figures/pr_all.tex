...
\addplot[color1,mark size=0pt] table [x=Recall,y=Precision] {../evaluations/figures/joint/predicate/RnnOIE.dat};
\addplot[color2,mark size=0pt] table [x=Recall,y=Precision] {../evaluations/figures/joint/predicate/OpenIE-4.dat};
\addplot[color3,mark size=0pt] table [x=Recall,y=Precision] {../evaluations/figures/joint/predicate/PropS.dat};
\addplot[color4,mark size=0pt] table [x=Recall,y=Precision] {../evaluations/figures/joint/predicate/ClausIE.dat};
...
\addplot[color1,mark size=0pt] table [x=Recall,y=Precision] {../evaluations/figures/joint/RnnOIE.dat} node[right,pos=0.9] {\tiny RnnOIE};
...
\addplot[color3,mark size=0pt] table [x=Recall,y=Precision] {../evaluations/figures/joint/PropS.dat} node[below,pos=0.8] {\tiny PropS};

...
e.g., not extracting \pred{win} as a stand-alone proposition in the first example in Table \ref{tab:oie_examples},
...
Subsequently, significant effort was put in devising automatic Open IE extractors, many of
...
%\todo{we need to say something it was just for verbs, the description in 3 assumes this later}

...
\addplot[color1,mark size=0pt] table [x=Recall,y=Precision] {../../evaluations/figures/joint/predicate/RnnOIE.dat}node[above,pos=1] {\tiny RnnOIE};
...
\addplot[color3,mark size=0pt] table [x=Recall,y=Precision] {../../evaluations/figures/joint/predicate/PropS.dat} node[below,pos=0.9] {\tiny PropS};
...
\addplot[color1,mark size=0pt] table [x=Recall,y=Precision] {../../evaluations/figures/joint/arguments/RnnOIE.dat}node[above,pos=1] {\tiny RnnOIE};
\addplot[color2,mark size=0pt] table [x=Recall,y=Precision] {../../evaluations/figures/joint/arguments/OpenIE-4.dat}node[below,pos=1] {\tiny OpenIE-4};
\addplot[color3,mark size=0pt] table [x=Recall,y=Precision] {../../evaluations/figures/joint/arguments/PropS.dat} node[below,pos=0.9] {\tiny PropS};
\addplot[color4,mark size=0pt] table [x=Recall,y=Precision] {../../evaluations/figures/joint/arguments/ClausIE.dat} node[above,pos=1] {\tiny ClausIE};
...
\subfloat[\small{Predicate extraction}]{
\label{fig:pred}
    \begin{tikzpicture}
  \begin{axis}[
  width = \aucwidth,
...
\subfloat[\small{Argument extraction}]{
\label{fig:arg}
    \begin{tikzpicture}
  \begin{axis}[
  width = \aucwidth,

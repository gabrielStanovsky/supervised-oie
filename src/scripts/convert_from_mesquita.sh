...
cut -f1 ../external_datasets/mesquita_2013/processed/penn.oie | sort -u > ../external_datasets/mesquita_2013/processed/penn.raw
...
cut -f1 ../external_datasets/mesquita_2013/processed/web.oie | sort -u > ../external_datasets/mesquita_2013/processed/web.raw
...
cut -f1 ../external_datasets/mesquita_2013/processed/nyt.oie | sort -u > ../external_datasets/mesquita_2013/processed/nyt.raw
